...
function ShopEntry({ shopItems }: Props) {
        ...
        <div className='background-light dark:background-dark'>
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="p-8 rounded shadow-xl sm:p-16">
                    ...
                    <Modal buttonText="Analysegespräch" buttonStyle="primary" buttonClassName="mx-auto relative top-9">
                        <div>
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
    ...
    const shopItems = await sanityClient.fetch(query)
