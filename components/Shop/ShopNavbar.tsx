    ...
    return (
        <div className="bg-light-container dark:bg-dark-container shadow-md mt-20">
            <div className="container flex items-center px-6 py-4 mx-auto overflow-y-auto whitespace-nowrap">
                <div className='flex'>
                    <a href="/shop" className="text-gray-600 dark:text-gray-200 flex">
                ...
                {path ? path.map((navItem, i) => (
                    <div className='flex items-center'>
                        <a href={navItem.href} className={`${i + 1 == path.length ? 'text-primary' : ''} dark:text-gray-200 hover:underline`}>
                            {`${navItem.title}`}
                        </a>
                        {i + 1 == path.length ?
                            null
