...
function Index() {
    return (
        <header className="">
            <nav className="bg-light-container dark:bg-dark-container shadow-md">
                <div className="container p-6 mx-auto">
                    <a className="block text-2xl font-bold text-center text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Brand</a>
