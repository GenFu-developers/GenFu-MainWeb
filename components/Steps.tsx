...
export default function Steps() {
    ...
    return (
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto flex items-center w-max">
                <div className="flex flex-wrap justify-center">
                    ...
                    {/* <img className="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="/illustration.svg" alt="step" /> */}
                </div>
            </div>
        </section>
    );
