            ...
            {!closed &&
                <div className={`w-full ${containerClassList}`}>
                    <div className="container relative flex px-6 basis-3/4 justify-center py-2 mx-auto">
                        ...
                        <button className="absolute right-0 p-1 self-end transition-colors duration-200 transform rounded-md hover:bg-opacity-25 hover:bg-gray-600 focus:outline-none"
