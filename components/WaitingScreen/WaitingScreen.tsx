    ...
    return (
        <div className='min-h-screen background-light dark:background-dark pt-20'>
            <div className='absolute right-0 top-5'>
                {isSSRDone &&
                    <motion.div animate={{ opacity: 1 }} initial={{ opacity: 0 }} transition={{ delay: 3 }} >
                        <ThemeSwitcher />
                    </motion.div>
                }
            </div>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <motion.form action='/api/waitinglist' method='POST'
                        ...
                        className="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:space-x-4 sm:space-y-0 space-y-4 sm:px-0 items-center">
                        <div className='flex flex-col flex-grow gap-5'>
                            <div className="relative flex-grow w-full flex gap-5">
